...
public final class HandlerResponse {
    ...
    public static void generateHandleResponse(HttpServletRequest request, HttpServletResponse response,
            Exception exception, HttpStatus status, String message) throws IOException {
