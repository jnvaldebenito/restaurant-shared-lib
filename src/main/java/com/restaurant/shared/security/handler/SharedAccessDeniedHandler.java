...
public class SharedAccessDeniedHandler implements AccessDeniedHandler {
  ...
  public void handle(
    ...
    String message =
        "Acceso denegado: no posees los permisos necesarios para acceder a esta función. Contacta al administrador si crees que esto es un error.";
    HandlerResponse.generateHandleResponse(
        request, response, accessDeniedException, HttpStatus.FORBIDDEN, message);
  }
}
