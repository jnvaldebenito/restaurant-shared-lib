...
/**
 * Utilidad centralizada para sanitización y validación de entrada de usuario. Previene XSS, SQL
 * Injection, Path Traversal y otros ataques de inyección.
 *
 * <p>Esta clase está en restaurant-shared-lib para ser usada por todos los microservicios.
 */
@Component
  ...
  private static final Pattern PATH_TRAVERSAL =
    ...
    if (!ALPHANUMERIC_SPACES.matcher(input).matches()) {
      throw new IllegalArgumentException(
          fieldName + " solo puede contener letras, números y espacios");
    }
