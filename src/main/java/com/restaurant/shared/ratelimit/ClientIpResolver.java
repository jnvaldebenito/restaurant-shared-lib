 ...
 * - Proxies reversos (X-Forwarded-For, X-Real-IP)
 * - Load balancers
 * - Conexiones directas
 * 
 * IMPORTANTE: Previene que se use la IP del proxy/CDN en lugar de la IP real
 * del cliente.
 */
@Slf4j
@Component
public class ClientIpResolver {
     ...
     * 3. X-Real-IP - Nginx y otros proxies
     * 4. X-Forwarded-For - Estándar de facto (puede contener múltiples IPs)
     * 5. Proxy-Client-IP - Apache y otros
     * 6. WL-Proxy-Client-IP - WebLogic
     * 7. HTTP_X_FORWARDED_FOR - Variante
     * 8. HTTP_CLIENT_IP - Variante
     */
    ...
    /**
     * Obtiene información de debug sobre todos los headers de IP.
