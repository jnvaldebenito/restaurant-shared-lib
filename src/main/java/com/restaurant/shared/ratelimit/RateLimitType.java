 ...
 * 
 * Cada tipo define:
 * - capacity: Número máximo de requests permitidos
 * - refillDuration: Ventana de tiempo para refill
 */
public enum RateLimitType {
    ...
    /**
     * Para endpoints de API generales.
     ...
     * Previene: Fraude y abuso
     */
    PAYMENT(10, Duration.ofMinutes(1)),

    /**
     * Para registro de nuevos usuarios.
     * Límite: 3 requests por hora
     * Previene: Spam y registro masivo
     */
